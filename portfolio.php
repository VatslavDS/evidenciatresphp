        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">Catàlogo</h1>
                            <p>Se creativo con nosotros</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <ul class="portfolio-filter text-center">
                    ...
                    <li><a class="btn btn-default" href="#" data-filter=".branded">Marcas</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".design">Diseño</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".folio">Folio</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".logos">Logos</a></li>
                    <li><a class="btn btn-default" href="#" data-filter=".mobile">Mobiles</a></li>
